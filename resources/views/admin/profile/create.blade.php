                ...
                <div class="card-body">
                    <form method="POST" action="">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <img id="finalphoto" width="300px" height="300px" src=""/>
                                <div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="prefix" type="text" class="form-control" name="prefix" value=""/>
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="suffix" type="text" class="form-control" name="suffix" value=""/>
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="links" type="text" class="form-control" name="links" value=""/>
                            </div>
                        </div>
